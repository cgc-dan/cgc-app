...
class Titlebar extends themebar_1.Themebar {
    ...
    registerListeners() {
        this.currentWindow.on(dom_1.EventType.FOCUS, () => {
            this.onDidChangeWindowFocus(true);
            this.onFocus();
        });
        this.currentWindow.on(dom_1.EventType.BLUR, () => {
            this.onDidChangeWindowFocus(false);
            this.onBlur();
        });
        this.currentWindow.on(dom_1.EventType.MAXIMIZE, () => {
            this.onDidChangeMaximized(true);
        });
        this.currentWindow.on(dom_1.EventType.UNMAXIMIZE, () => {
            this.onDidChangeMaximized(false);
        });
        this.currentWindow.on(dom_1.EventType.ENTER_FULLSCREEN, () => {
            this.onDidChangeFullscreen(true);
        });
        this.currentWindow.on(dom_1.EventType.LEAVE_FULLSCREEN, () => {
